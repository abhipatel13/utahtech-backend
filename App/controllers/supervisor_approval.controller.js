...
/**
 * Helper function to determine if approval is required for an entity
 */
const requiresApproval = (approvableType, risks) => {
  switch (approvableType) {
    case 'task_hazards':
      // Task hazards require approval only if risks require supervisor signature
      return risks && risks.some(risk => risk.requiresSupervisorSignature);
    case 'risk_assessments':
      // Risk assessments always require approval
      return true;
    default:
      return false;
  }
